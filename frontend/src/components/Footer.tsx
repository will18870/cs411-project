export default function Footer() {
    return (
      <>
        <footer className=" pt-8 pb-8 bg-gray-200 flex justify-between items-center ">
            <p className=" pl-10 text-sm text-gray-600">&copy; 2023 CS411 Class Project - Boston University</p>
